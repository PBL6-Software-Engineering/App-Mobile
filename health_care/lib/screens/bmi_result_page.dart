        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text('Chỉ số BMI của bạn là ${bmi.toStringAsFixed(1)}.',
                  style: TextStyle(fontSize: 16.0)),
              SizedBox(height: 16),
              TagContainer(tag: "Tình trạng"),
              SizedBox(height: 8),
              Text(
                  'Chỉ số BMI của bạn cho thấy bạn đang ở tình trạng ${advice[0]}',
                  style: TextStyle(fontSize: 16.0)),
              SizedBox(height: 16),
