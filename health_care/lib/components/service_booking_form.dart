...
class _ServiceBookingFormState extends State<ServiceBookingForm> {
  ...
  Future<void> fetchBooking() async {
    ...
    try {
      final response =
          await HttpProvider().getData('api/time-work/service/${widget.id}');
  ...
  _ServiceBookingForm(int id, String date, List<dynamic> interval) async {
    var data = {
    ...
    try {
      var res =
          await HttpProvider().postData(data, 'api/work-schedule/add-service');
